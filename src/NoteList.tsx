...
type EditTagModalProps = {
    ...
    availableTags: Tag[]
    handleClose: () => void
    onDeleteTag: (id: string, label: string) => void
    onUpdateTag: (id: string, label: string) => void
}
...
export function NoteList({ availableTags, notes, onDeleteTag, onUpdateTag }: NoteListProps) {
    ...
    return notes.filter(note => {
        ...
        .includes(title.toLowerCase())) && (selectedTags.length === 0 || selectedTags.every(tag => 
...
function EditTagsModal({ availableTags, handleClose, show , onDeleteTag, onUpdateTag}: EditTagModalProps) {
